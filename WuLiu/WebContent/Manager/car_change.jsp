...
%>
  <tr>
    ...
    <td width="32%" height="34" ><input type="text" name="numbers" size="20"value="<%=rs.getString("TradeMark")%>"></td>
  ...
  <tr>
    ...
    <td width="31%" height="37" ><input type="text" name="time" size="20"value="<%=rs.getString("DriverTime")%>">年</td>
