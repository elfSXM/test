...
<form action="car_Config.jsp" method="post"name="form1">
<table width="785" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  <tr>
    <td width="100%" height="62" colspan="4" align="center">车辆信息添加</td>
  </tr>
  ...
  <tr>
    ...
    <td width="32%" height="34"><input type="text" name="numbers" size="20"></td>
    <td width="19%" height="34" align="center">车辆品名：</td>
    <td width="31%" height="34"><input type="text" name="carname" size="20"></td>
  </tr>
  <tr>
    <td width="18%" height="36" align="center">车辆类型：</td>
    <td width="32%" height="36"><input type="text" name="type" size="20"></td>
    <td width="19%" height="36" align="center">车辆限量：</td>
    <td width="31%" height="36"><input type="text" name="loads" size="20">吨</td>
  </tr>
  <tr>
    <td width="18%" height="37" align="center">已使用：</td>
    <td width="32%" height="37"><input type="text" name="usetime" size="20">年</td>
       <td width="18%" height="37" align="center">驾驶员名称：</td>
    <td width="32%" height="37"><input type="text" name="name" size="20"></td>
  </tr>
  <tr>
    <td width="19%" height="37" align="center">驾驶员驾龄：</td>
    <td width="31%" height="37"><input type="text" name="time" size="20">年</td>
    <td width="18%" height="36" align="center">驾驶证号码：</td>
    <td width="32%" height="36"><input type="text" name="number" size="20"></td>
  </tr>
  <tr>
...
<select size="1" name="transtyle">
  ...
  <tr>
    ...
    <td width="32%" height="42" ><input type="text" name="linkman" size="20"></td>
    <td width="19%" height="42" align="center">联系电话：</td>
    <td width="31%" height="42"><input type="text" name="phone" size="20"></td>
  </tr>
  <tr>
    <td width="18%" height="65" align="center">备注：</td>
    <td width="82%" height="65" colspan="3">
   <textarea rows="3" name="meg" cols="76"></textarea></td>
  </tr>
  <tr>
    <td width="18%" height="42" align="center">发布时间：</td>
    <td width="32%" height="42"><input type="text" name="code" size="20"></td>
      <p align="center"></td>
    
  </tr>
<tr>
    <td width="18%" height="42" align="center">发布人：</td>
    <td width="32%" height="42" colspan="3"><input type="text" name="username" size="20"></td>
  ...
  <td width="104%" height="40" colspan="4">
   ...
   <input type="button" value="返回" onClick="location.href='car_select.jsp'">
</td>
</td>
  </tr>
</table>
