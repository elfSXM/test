...
<table width="786" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  <tr>
    <td width="100%" height="62" colspan="4">
      <p align="center"><font size="5">车辆信息展示</font></td>
  </tr>
<%
...
{%>
 ...
 <tr>
      <td width="100%" height="33" colspan="4" align="center">
         ...
         <input style="border-width:1px;background:none;" type="button" value="修改" onClick="location.href='car_change.jsp?id=<%=code%>'"> &nbsp;&nbsp;
        
         <input style="border-width:1px;background:none;" type="button" value="删除" onClick="location.href='car_delete.jsp?id=<%=code%>'">
...
<tr>
<td align="right">
<input  style="border-width:1px;background:none;" type="button" value="返回" onClick="history.back()"></td>
</tr>
</table>
