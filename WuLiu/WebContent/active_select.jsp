...
<table width="820" height="117" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  ...
  <tr>
    ...
    <td width="245" height="29" align="center">标题</td>
    <td width="150" height="29" align="center">作者</td>
...
共<%=pagecount%>页</font>&nbsp;&nbsp;
        <a href="active_select.jsp?topage=<%=1%>"><font size="2">首页</font></a>&nbsp;&nbsp;
        <a href="active_select.jsp?topage=<%=showpage-1%>"><font size="2">上一页</font></a>&nbsp;&nbsp;
        <a href="active_select.jsp?topage=<%=showpage+1%>"><font size="2">下一页</font></a>&nbsp;&nbsp;
        <a href="active_select.jsp?topage=<%=pagecount%>"><font size="2">尾页&nbsp;&nbsp;&nbsp;&nbsp;</a>
