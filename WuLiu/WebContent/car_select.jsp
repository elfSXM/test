...
<table width="800" height="137" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#333333">
  ...
  <tr>
   ...
   <a href="car_add.jsp"><font size="2">发布信息...&nbsp;&nbsp;&nbsp;&nbsp;</font></a></td>
  </tr>
  <tr>
  <td width="11%" height="29" align="center">发布人</td>
...
<td width="12%" height="29" align="center"><a href="car_show.jsp?id=<%=n%>"><font size="3">详细</font></a></td>
</tr>
<%
if(!rs.next())
break;
...
<table width="786" align="center" cellpadding="0" cellspacing="0">
	<tr>
    <td width="786" height="30" colspan="9" align="right">
   <font size="2"> 共<%=pagecount%>页</font>&nbsp;&nbsp;
        <a href="car_select.jsp?topage=<%=1%>"><font size="2">首页</font></a>&nbsp;&nbsp;
        <a href="car_select.jsp?topage=<%=showpage-1%>"><font size="2">上一页</font></a>&nbsp;&nbsp;
        <a href="car_select.jsp?topage=<%=showpage+1%>"><font size="2">下一页</font></a>&nbsp;&nbsp;
        <a href="car_select.jsp?topage=<%=pagecount%>"><font size="2">尾页&nbsp;&nbsp;&nbsp;&nbsp;</font></a>
